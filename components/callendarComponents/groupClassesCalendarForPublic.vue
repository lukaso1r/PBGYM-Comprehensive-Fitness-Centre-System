...
const calendar = computed(() => {
    ...
    days.forEach(day => {
        ...
        isSameDay(new Date(groupClass.dateStart), day)).concat(groupClassesStore.groupClassesHistorical.filter(groupClass => isSameDay(new Date(groupClass.dateStart), day)));

...
<div class="flex flex-row bg-[#F5F7F8] items-start pb-10 min-h-screen">
    ...
    <main  v-if="checkPermission(['TRAINER_MANAGEMENT'])"  class="basis-4/5 mt-4 flex flex-col flex-wrap items-start justify-start gap-8">
        ...
        <WorkerComponentsTrainersList  v-if="checkPermission(['TRAINER_MANAGEMENT'])"  :showButton="false"/>

        <UButton  v-if="checkPermission(['TRAINER_MANAGEMENT'])"  label="Dodaj trenera" @click="showAddNewTrainerModal = true" color="blue" icon="i-material-symbols-add" />

    ...
    <main class="basis-4/5 mt-4 flex flex-col flex-wrap items-start justify-start gap-8">
        ...
        <div class="flex flex-row flex-wrap gap-8" >
            <div class="stats w-max flex flex-col rounded-lg p-4 bg-white flex-nowrap gap-2 " style="box-shadow: 0px 0px 24px -8px rgba(66, 68, 90, 1);">
                ...
                <p class="text-slate-500">Możesz zobaczyć tutaj statystyki pracy trenera</p>
            </div>
        ...
        <div class="stats w-max flex flex-col rounded-lg p-4 bg-white flex-nowrap gap-2 " style="box-shadow: 0px 0px 24px -8px rgba(66, 68, 90, 1);">
            <h1 class="text-xl font-semibold">Informacje i edycja danych</h1>
            <p class="text-slate-500">Możesz zobaczyć tutaj sprawdzić informacje o swoim koncie oraz je edytować</p>
        </div>
